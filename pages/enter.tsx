...
const Enter: NextPage = () => {
  ...
  return (
    <div className="mt-16 lg:px-10 sm: px-4">
      <h3 className="text-2xl text-center font-bold">Welcome to Carrot</h3>
      <div className="mt-12">
        <div className="flex flex-col items-center">
          <h5 className="font-bold text-gray-500">Enter using:</h5>
          <div className="mt-10 grid grid-cols-2 border-b w-full">
            <button
            className={`pb-3 ${method === "email" ? "border-orange-500 border-b text-orange-300" : ""}`}
            onClick={onEmailClick}>Email Adress</button>
            <button
            className={`pb-3 ${method === "phone" ? "border-orange-500 border-b text-orange-300" : ""}`}
            onClick={onPhoneClick}>Phone Number</button>
          </div>
        </div>
