...
const Home: NextPage = () => {
    return (
      <div className="flex flex-col space-y-5 py-5 px-2">
          ...
          <div key={i} className="flex border-b pb-4 cursor-pointer justify-between">
            <div className="flex space-x-3">
              ...
              <div className="pt-1 flex flex-col">
                <h3 className="text-sm font-medium text-gray-500">New iPhone 14</h3>
                <span className="pt-1 text-xs">🇩🇪</span>
                <span className="font-medium mt-1 text-gray-900">$95</span>
              </div>
            </div>
            <div className="flex space-x-2 items-end justify-end">
              <div className="flex space-x-0.5 items-center text-center text-gray-500 ">
                <svg
                  className="w-4 h-4"
                  fill="none"
                  stroke="currentColor"
